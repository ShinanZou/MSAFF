...
#     palette = np.array(sns.color_palette("husl", 8))
...
#         txts.append(txt)
#     plt.savefig('./stgrm.png', dpi=1000)
#     plt.savefig('./stgrm.eps', format='eps', dpi=1000, 
#                 ) # 注意两个参数
#     return f, ax, txts

# tinydict = {'0020': 0, '0058': 1, '0087': 2,
#             '0405': 3, '0506': 4, '0695': 5,
#             '2078': 6, '3358': 7}
